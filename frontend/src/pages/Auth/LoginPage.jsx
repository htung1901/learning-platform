...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-linear-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950"></div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-white/50 dark:border-slate-700/50">
          ...
          <div className="text-center mb-8">
            <div className="w-14 h-14 bg-linear-to-br from-blue-600 to-purple-600 rounded-lg flex items-center justify-center mx-auto mb-4 shadow-lg">
        ...
        <p className="text-center text-xs text-slate-500 dark:text-slate-400 mt-4">
          Demo Student: student.demo | 123456
          <br />
          Demo Instructor: instructor.demo | 123456
        </p>
      </div>
    </div>
  );
